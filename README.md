...
The URL of the GitHub repository is https://github.com/Selvan92/PWA-TextEditor and the repository name is 19-PWA-Text-Editor.

🚀The application has been deployed to Heroku and the URL of the deployed application is:-
 
https://selvan92-80466.herokuapp.com/
